  ...
  return (
    <div className="relative h-[50vh] flex items-center justify-center my-6 mx-6 rounded-2xl overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <motion.div
          className="absolute inset-0 bg-gradient-to-br from-[var(--theme-color-1)] via-purple-600 to-pink-500"
          animate={{
            background: [
              'white']
          }}
      ...
      >
        <h1 className="text-4xl text-[var(--theme-color-1)] sm:text-5xl md:text-6xl font-bold mb-6 leading-tight">
          Get in Touch
        </h1>
